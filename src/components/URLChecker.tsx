...
import { Link2, Shield, AlertTriangle, Loader2 } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="flex items-center mb-6">
        <Link2 className="h-6 w-6 text-blue-500 mr-2" />
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">URL Checker</h2>
      </div>
